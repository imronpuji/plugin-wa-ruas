...
add_action('admin_menu', 'test_plugin_setup_menu');
	...
	function create_table_wa_ruas(){
		...
		$sql .= "wc_pending varchar(255) NULL,";
		$sql .= "wc_processing varchar(255) NULL,";
		$sql .= "wc_on_hold varchar(255) NULL,";
		$sql .= "wc_completed varchar(255) NULL,";
		$sql .= "wc_cancelled varchar(255) NULL,";
		$sql .= "PRIMARY KEY (id)";
		$sql .= ")";
		$sql .= $charset_collate;
